  ...
  [EPage.AUCTIONS]: {
    ...
    description: (
      <>
        ...
        <p>
          When an auction starts it runs for 24 hours; when the timer ends, the highest bidder receives the tokens and the ETH moves to the dividend pool for SIR stakers.
        </p>
      </>
    ),
  },
