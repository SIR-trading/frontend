      ...
      <div className="flex items-center gap-x-3">
        <div>
          <button
            ...
            aria-label="Left"
            onClick={prevPage}
            className="rounded-full bg-primary/10 p-[5px] disabled:opacity-50 dark:bg-primary"
          >
            <ChevronLeft size={17} />
          </button>
        </div>
        <div className="flex h-[25px] items-center rounded-lg bg-primary/10 px-3 text-[15px] dark:bg-primary">
          {page}
        </div>
        <div>
          <button
