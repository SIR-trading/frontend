...
const badgeVariants = cva(
  "inline-flex items-center w-[64px] gap-x-[2px] rounded-md border flex justify-center py-0.2 md:py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "border-transparent bg-accent hover:bg-accent-100",
        yellow: "border-transparent bg-[#f6a037] hover:bg-[#e0800b]",
        green: "border-transparent bg-accent hover:bg-accent-200",
        orange: "border-transparent bg-[#eb5f1e] hover:bg-[#c54a11]",
