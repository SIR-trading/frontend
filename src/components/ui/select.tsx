...
const selectTriggerVariants = cva(
  "flex h-8 w-full items-center justify-between rounded-md p-2 placeholder:text-foreground text-sm" +
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border-2 border-gray bg-primary/7 shadow-md backdrop-blur-3xl  dark:bg-tertiary" +
